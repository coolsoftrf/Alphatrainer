...
public class DynamicListView extends ListView {
    ...
    /**
     * Serves to remove highlight from single-clicked item
     */
    private final AdapterView.OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
        @Override
...
*/
            ...
            observer.addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                public boolean onPreDraw() {
                    ...
                    View originalView = getViewForID(mMobileItemId);
